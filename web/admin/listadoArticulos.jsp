...
<html>
                        ...
                        <c:forEach var="f" items="${res.rows}" varStatus="st">
                            ...
                            <tr ${st.index % 2==0 ? 'class="par"':''}>
                                <td style="text-align: center"><a href="<c:url value="EditaArticulo"><c:param name="idArt" value="${f.codigo}"/></c:url>"><img src="../img/edit.gif" title="Editar"/></a></td>
                                    ...
                                    <td><a href="<c:url value="../FichaArticulo"><c:param name="codArt" value="${f.codigo}"/></c:url>">${f.codigo}</a></td>
                                <td>${f.fabricante}</td> <!-- La F está añadida, mal añadida, adrede -->
                                <td>${f.tipo}</td>
                                <td>${f.nombre}</td>
    ...
    <script src="../js/ej11-administracion.js" type="text/javascript"></script>
